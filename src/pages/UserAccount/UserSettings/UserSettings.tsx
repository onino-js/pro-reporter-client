  ...
  public render() {
    return (
      <MainLayout>
        <SubLayout
          activePage="contacts"
          sideContent={<UserAccountNavigation activePage={"user-settings"} />}
        >
          <ProContainer>
            <Flex dir="c" alignH="center" alignV="center">
              ...
              <Text2>
                Sure cette page vous pourrez modifier certains paramètres tels
                que le langage de l'application, le thème ou encore configurer
                la sauvegarde automatique des modifications.
              </Text2>
            </Flex>
          </ProContainer>
        </SubLayout>
