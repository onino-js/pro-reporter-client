    ...
    return (
      <MainLayout>
        <SubLayout
          activePage="contacts"
          sideContent={
            <UserAccountNavigation activePage={"user-informations"} />
          }
        >
          <ProContainer>
            <Flex dir="c" alignH="center" alignV="center">
              ...
              <Text2>
                Avec la page "Informations", vous pourrez facilement retrouver
                et modifier vos informations personnelles.
              </Text2>
            </Flex>
          </ProContainer>
        </SubLayout>
